...
RenderManager::~RenderManager() {
	ModelGeometries::cleanUp();
	delete genShader;
}

void RenderManager::loadModel() {
	ModelGeometries::generateCube();
	ModelGeometries::generateSphere(20);
}
...
void RenderManager::render(ModelData* model, Texture* texture, const glm::vec3& position, const glm::vec3& rotation_deg, const glm::vec2& scale, const glm::vec4& color) {
	prepare(genShader);
